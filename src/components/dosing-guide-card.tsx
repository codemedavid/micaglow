...
interface DosingGuideCardProps {
  peptide: Peptide
  onViewDetails: (peptide: Peptide) => void
}

export function DosingGuideCard({ peptide, onViewDetails }: DosingGuideCardProps) {
  ...
  return (
    <Card className="group overflow-hidden hover:shadow-xl hover:border-primary/30 transition-all duration-300 bg-gradient-to-br from-card to-primary/[0.01]">
